    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function(auth, method, path, request) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
           ...
           https://github.com/cloudflare/next-on-pages/issues/487 */ if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$util$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCloudflareWorker"])()) {
                                    ...
                                    return [
                                        2,
                                        FetchProvider.fetch()(_getFinalTarget(auth, auth.config.apiHost, path, query), fetchArgs)
                                    ];
                            }
                        });
                    })();
                        ...
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                            switch(_state.label){
                                ...
                                case 1:
                                    ...
                                    if (!((_a = this._popupRedirectResolver) === null || _a === void 0 ? void 0 : _a._shouldInitProactively)) return [
                                        3,
                                        5
                                    ];
                                    _state.label = 2;
...
function injectRecaptchaFields(auth, request, action) {
    var captchaResp = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function() {
        var verifier, captchaResponse, error, newRequest;
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
            switch(_state.label){
                case 0:
...
function handleRecaptchaFlow(authInstance, request, actionName, actionMethod) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(function() {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
            switch(_state.label){
                case 0:
                    if (!((_a = authInstance._getRecaptchaConfig()) === null || _a === void 0 ? void 0 : _a.isProviderEnabled("EMAIL_PASSWORD_PROVIDER" /* RecaptchaProvider.EMAIL_PASSWORD_PROVIDER */ ))) return [
                        3,
                        2
                    ];
                    return [
                    ...
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                        switch(this.signInMethod){
                            case "password" /* SignInMethod.EMAIL_PASSWORD */ :
                                ...
                                return [
                                    2,
                                    handleRecaptchaFlow(auth, request, "signInWithPassword" /* RecaptchaActionName.SIGN_IN_WITH_PASSWORD */ , signInWithPassword)
                                ];
                    ...
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                        switch(this.signInMethod){
                            case "password" /* SignInMethod.EMAIL_PASSWORD */ :
                                ...
                                return [
                                    2,
                                    handleRecaptchaFlow(auth, request, "signUpPassword" /* RecaptchaActionName.SIGN_UP_PASSWORD */ , linkEmailPassword)
                                ];
                            case "emailLink" /* SignInMethod.EMAIL_LINK */ :
                                return [
                                    2,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        handleRecaptchaFlow(authInternal, request, "getOobCode" /* RecaptchaActionName.GET_OOB_CODE */ , sendPasswordResetEmail$1)
                    ];
                case 1:
                    _state.sent();
                    return [
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
            switch(_state.label){
                case 0:
                    ...
                    return [
                        4,
                        handleRecaptchaFlow(authInternal, request, "getOobCode" /* RecaptchaActionName.GET_OOB_CODE */ , sendSignInLinkToEmail$1)
                    ];
                case 1:
                    _state.sent();
                    return [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_create_class$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(BrowserLocalPersistence, [
        ...
        },
        {
            ...
            function _set(key, value) {
                var _this = this;
                var _this1 = this, _superprop_get__set = function _superprop_get__set() {
        ...
        },
        {
            ...
            value: function _get(key) {
                var _this = this;
                var _this1 = this, _superprop_get__get = function _superprop_get__get() {
        ...
        },
        {
            ...
            value: function _remove(key) {
                var _this = this;
                var _this1 = this, _superprop_get__remove = function _superprop_get__remove() {
                        ...
                        switch(_state.label){
                            ...
                            case 1:
                                ...
                                return [
                                    2,
                                    new Promise(function(resolve) {
                                        var tokenChange = function tokenChange1(token) {
                                            if (!token) {
...
var RedirectAction = /*#__PURE__*/ function(AbstractPopupRedirectOperation) {
     ...
     */ function execute() {
                var _this = this;
                var _this1 = this, _superprop_get_execute = function _superprop_get_execute() {
        ...
        },
        {
            ...
            value: function onAuthEvent(event) {
                var _this = this;
                var _this1 = this, _superprop_get_onAuthEvent = function _superprop_get_onAuthEvent() {
...
//# sourceMappingURL=node_modules_%40firebase_auth_dist_esm2017_15tzvs-._.js.map